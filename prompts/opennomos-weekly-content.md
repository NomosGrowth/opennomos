...
- Make the plan specific enough that daily draft staging can follow it without re-deciding the whole week.
- Do not stage all daily platform drafts in the weekly planning pass unless the operator explicitly asks.
